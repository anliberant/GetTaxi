...
import static com.example.gettaxi.R.id.loginSignUpButton;
import static com.example.gettaxi.R.id.passengerMap;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getNearestDriverLocation() {
        ...
        nearestDriverLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    List<Object> driverLocationParams = (List<Object>) snapshot.getValue();
                    double latitude = 0.0;
                    ...
                    bookTaxiButton.setText("Distance to your Driver is " + distanceToDriver);
    ...
    private void updateLocationUI() {
        if (currentLocation != null) {
            ...
            mMap.addMarker(new MarkerOptions().position(currentLatLng).title("Passenger location: "));
    ...
    private void requestLocationPermission() {
        ...
        if (shouldProvideRationale) {
            showSnackBar(
                    "Location permission is need for app functionality",
                    "Ok",
